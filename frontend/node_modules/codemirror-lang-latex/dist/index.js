...
import { syntaxTree, bracketMatching, LRLanguage, indentNodeProp, foldNodeProp, foldInside, foldService, LanguageSupport } from '@codemirror/language';
...
function latexLinter(options = {}) {
    ...
    return (view) => {
        ...
        if (opts.checkUnmatchedEnvironments) {
            const beginEnvs = new Map();
            const endEnvs = new Map();
            ...
            tree.cursor().iterate(node => {
                ...
                if (node.name === 'BeginEnv') {
                    ...
                    if (envNameNode) {
                        ...
                        (_a = beginEnvs.get(envName)) === null || _a === void 0 ? void 0 : _a.push(node.from);
                    }
                }
...
function latex(config = {}) {
    ...
    const extensions = [];
    extensions.push(latexLanguage.data.of({
...
function findEnvironmentName(node) {
...
function findMatchingEnvironment(doc, pos, tree) {
    var _a, _b;
    const node = tree.resolve(pos);
...
function findSectionBoundaries(node) {
    if (!node)
        return null;
