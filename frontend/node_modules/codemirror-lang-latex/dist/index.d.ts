...
declare const autoCloseTags: (StateField<{
    active: boolean;
    lastEnv: string | null;
}> | _codemirror_state.Extension)[];

declare const snippets: readonly Completion[];
declare function latexCompletionSource(autoCloseTagsEnabled: boolean): (context: CompletionContext) => CompletionResult | null;

declare const latexBracketMatching: Extension;
declare const latexLanguage: LRLanguage;
declare const latexExtensions: Extension;
declare const latexCompletions: {
    environments: readonly string[];
    commands: readonly string[];
    mathCommands: readonly string[];
    packages: readonly string[];
};

declare function latex(config?: {
...
declare function latexLinter(options?: {
 ...
 */
declare const latexHoverTooltip: _codemirror_state.Extension & {
    active: _codemirror_state.StateField<readonly Tooltip[]>;
};
...
const specializeCtrlSeq = (name, terms) => {
...
const specializeEnvName = (name, terms) => {
...
const specializeCtrlSym = (name, terms) => {
...
declare function findEnvironmentName(node: SyntaxNode): string | null;
declare function getIndentationLevel(node: SyntaxNode): number;
declare function findMatchingEnvironment(doc: string, pos: number, tree: any): {
    from: number;
    to: number;
} | null;
declare function findSectionBoundaries(node: SyntaxNode): {
    from: number;
    to: number;
} | null;

export { autoCloseTags, findEnvironmentName, findMatchingEnvironment, findSectionBoundaries, getIndentationLevel, latex, latexBracketMatching, latexCompletionSource, latexCompletions, latexExtensions, latexHoverTooltip, latexLanguage, latexLinter, parser, snippets };
